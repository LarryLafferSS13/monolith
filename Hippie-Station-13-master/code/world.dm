...
/world/proc/update_status()
	...
	s += "<b>Monolith Station 13</b>"
	s += " <br>"
	s += "<img src=\"http://i.imgur.com/yhNrKZV.png\">"
	s += "=* Monolith Station - Sandbox *="  //Replace this with something else. Or ever better, delete it and uncomment the game version.
	s += "</a>"
	s += "<br>"
